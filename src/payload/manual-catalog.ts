...
const spec = (
  ...
  valueFa: string,
  sortOrder: number,
): ManualTechnicalSpec => ({ key, labelFa, valueFa, sortOrder });
...
export const manualCatalogProducts: ManualCatalogProduct[] = [
  {
    ...
    technicalSpecs: [
      spec("headboard-frame", "جنس تاج تخت", "MDF و چوب چندلایی", 10),
      spec("body", "جنس بدنه", "MDF با روکش طبیعی چوب راش", 20),
      spec("headboard-cover", "نوع روکش تاج", "پارچه", 30),
      spec("leg", "جنس پایه", "چوب راش", 40),
      spec("filling", "جنس پرکننده", "ورق اسفنجی برش‌خورده", 50),
      spec("base-frame", "جنس اسکلت کفی", "آهنی", 60),
      spec("storage", "فضای انبارش", "ندارد", 70),
      spec("delivery", "شرایط تحویل", "دمونتاژ", 80),
    ],
    variantAttributes: [{
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("headboard-frame", "جنس تاج تخت", "چوب راش", 10),
      spec("body", "جنس بدنه", "چوب راش", 20),
      spec("headboard-cover", "نوع روکش تاج", "پارچه و چوب راش", 30),
      spec("leg", "جنس پایه", "چوب راش", 40),
      spec("filling", "جنس پرکننده", "ورق اسفنجی", 50),
      spec("base-frame", "جنس اسکلت کفی", "آهنی", 60),
      spec("storage", "فضای انبارش", "ندارد", 70),
      spec("delivery", "شرایط تحویل", "دمونتاژ؛ مونتاژ در محل مشتری توسط نیلپر", 80),
    ],
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("headboard-frame", "جنس تاج تخت", "MDF با روکش ملامینه", 10),
      spec("body", "جنس بدنه", "MDF با روکش ملامینه", 20),
      spec("headboard-cover", "نوع روکش تاج", "پارچه و روکش ملامینه", 30),
      spec("leg", "جنس پایه", "بدون پایه", 40),
      spec("filling", "جنس پرکننده", "ورق اسفنجی", 50),
      spec("base-frame", "جنس اسکلت کفی", "آهنی", 60),
      spec("storage", "فضای انبارش", "ندارد", 70),
      spec("delivery", "شرایط تحویل", "دمونتاژ؛ مونتاژ در محل مشتری توسط نیلپر", 80),
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("headboard-frame", "جنس تاج تخت", "MDF و چوب چندلایی", 10),
      spec("body", "جنس بدنه", "MDF با روکش پارچه", 20),
      spec("headboard-cover", "نوع روکش تاج", "پارچه", 30),
      spec("leg", "جنس پایه", "چوب راش", 40),
      spec("filling", "جنس پرکننده", "ویسکوز", 50),
      spec("base-frame", "جنس اسکلت کفی", "آهنی", 60),
      spec("storage", "فضای انبارش", "دارد", 70),
      spec("delivery", "شرایط تحویل", "دمونتاژ", 80),
    ],
    variantAttributes: [bedWidthType, bedBaseType],
    variants: [
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("frame", "جنس اسکلت", "چوب چندلایی", 10),
      spec("leg", "جنس پایه", "چوب راش", 20),
      spec("back", "جنس پشتی", "ابر اسفنجی", 30),
      spec("back-type", "نوع پشتی", "یکپارچه با بدنه", 40),
      spec("seat", "جنس نشیمن", "چوب چندلایی", 50),
      spec("seat-type", "نوع نشیمن", "یکپارچه با بدنه", 60),
      spec("seat-cushion", "تشک نشیمن", "ابر اسفنجی", 70),
      spec("delivery", "شرایط تحویل", "مونتاژ", 80),
    ],
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("frame", "جنس اسکلت بدنه", "MDF و چوب چندلایی روکش‌شده با پارچه", 10),
      spec("cover", "نوع روکش", "پارچه", 20),
      spec("leg", "جنس پایه", "چوب راش", 30),
      spec("filling", "جنس پرکننده", "ورق اسفنجی برش‌خورده", 40),
      spec("base-frame", "جنس اسکلت کفی", "آهنی", 50),
      spec("storage", "فضای انبارش", "ندارد", 60),
      spec("delivery", "شرایط تحویل", "دمونتاژ", 70),
    ],
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("headboard-frame", "جنس تاج تخت", "چوب راش و MDF", 10),
      spec("body", "جنس بدنه", "چوب راش و MDF", 20),
      spec("headboard-cover", "نوع روکش تاج", "چوب راش و MDF", 30),
      spec("leg", "جنس پایه", "چوب راش", 40),
      spec("base-frame", "جنس اسکلت کفی", "فلز و MDF", 50),
      spec("storage", "فضای انبارش", "ندارد", 60),
      spec("delivery", "شرایط تحویل", "دمونتاژ؛ مونتاژ در محل مشتری توسط نیلپر", 70),
    ],
  ...
  },
  {
    ...
    technicalSpecs: [
      spec("frame", "جنس اسکلت بدنه و دسته", "چوب چندلایی", 10),
      spec("suspension", "نوع تعلیق", "تسمه‌کشی", 20),
      spec("leg", "جنس پایه", "چوب راش گرجستان", 30),
      spec("backrest", "نوع پشتی", "یکپارچه با بدنه", 40),
      spec("seat", "نوع نشیمن", "مجزا و متصل به بدنه", 50),
      spec("back-cushion", "جنس تشک پشتی", "اسفنج ۳۵ کیلویی", 60),
      spec("seat-cushion", "جنس تشک نشیمن", "فوم تزریقی پلی‌اورتان", 70),
      spec("delivery", "شرایط تحویل", "مونتاژشده", 80),
    ],
    variantAttributes: [
      {
        name: "seating-form",
